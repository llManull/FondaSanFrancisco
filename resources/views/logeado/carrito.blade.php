    ...
    <section class="py-24 relative">
        <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            ...
            @foreach ($productosCarrito as $item)
                <div style="background-color: #e5dfd8;"
                    class="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 ">
                    <div class="col-span-12 lg:col-span-2 img box flex justify-center">
                        <img width="250" src="{{ asset('storage/uploads/' . $item->attributes->image) }}" alt="{{ $item->name }}"
                    ...
                    <div class="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                        ...
                        <div class="flex m-4 justify-center">
                            <p style="color: #000;" class="font-normal text-base leading-7 text-gray-500 mb-6">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center gap-4">
                                ...
                                <form action="/carrito/quitar" method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ "$item->id" }}">
                                    <button onclick="return confirm('¿Eliminar del Carrito?') ? true : false"
                                        class="w-12 h-12 flex items-center m-4 justify-center bg-red-700 text-white">
